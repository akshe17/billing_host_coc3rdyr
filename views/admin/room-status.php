...
<div class="mb-8 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
    <div>
        ...
        <p class="mt-1 text-sm text-slate-500">Statuses used to describe the current state of a room.</p>
    </div>
        ...
        <table class="min-w-full text-sm">
            ...
            <tbody class="divide-y divide-slate-100">
                <?php foreach ($statuses as $s): ?>
                    <tr class="hover:bg-slate-50 room-status-row"
    ...
    <div id="emptyState" class="hidden text-center py-16">
        <div class="inline-flex items-center justify-center w-12 h-12 rounded-full bg-slate-100 text-slate-400 mb-3">
            <svg class="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.5">
                <path stroke-linecap="round" stroke-linejoin="round" d="M9 12h6m-6 4h6M5 8h14M5 12h14M5 16h14"/>
            </svg>
        </div>
    ...
    <div class="relative bg-white rounded-2xl shadow-2xl w-full max-w-lg max-h-[90vh] flex flex-col">
        ...
        <div class="flex items-center justify-between px-6 py-5 border-b border-slate-200">
            <div class="flex items-center gap-3">
                ...
                <div>
                    <h3 id="statusModalTitle" class="text-base font-semibold text-slate-900">New Room Status</h3>
                    <p class="text-xs text-slate-500">Define the status name and its display color.</p>
                </div>
            </div>
        ...
        <form id="statusForm" method="POST" novalidate class="flex-1 overflow-y-auto">
            ...
            <div class="p-6 space-y-5">
                ...
                <div>
                    ...
                    <input type="text" id="status_name" required placeholder="e.g. Available, Occupied"
    ...
    <div class="relative bg-white rounded-2xl shadow-2xl w-full max-w-md">
        <div class="p-6">
            <div class="flex items-start gap-4">
                ...
                <div>
                    <h3 class="text-base font-semibold text-slate-900">Delete this room status?</h3>
                    <p class="mt-1.5 text-sm text-slate-500">
                        <strong id="deleteStatusName" class="text-slate-700"></strong> will be permanently removed.
                        This action cannot be undone.
                    </p>
                    <p class="mt-2 text-xs text-slate-500">
                        If any room is still using this status, the delete will be blocked.
                    </p>
                </div>
            </div>
        </div>
